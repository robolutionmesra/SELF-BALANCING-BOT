...
long unsigned int enc_count_1=0, enc_count_2=0;
...
long long unsigned int timer,loop_timer,void_loop_timer;
boolean flag;
...
void loop() 
{ 
  if((millis()-void_loop_timer)>20000)
  {
    void_loop_timer = millis();
    I = 0;
  }
  ...
  kp = 4.25; //4.25 //3.2  3.3  3.4                                 //4.25
  ki = 0;
  kd = 0.1;   //0.071  //0.63 0.65  0.71                            //0.4
...
void SET_MPU_OFFSET()
{
  ...
  accelgyro.setXAccelOffset(-729);
  accelgyro.setYAccelOffset(-1384);
  accelgyro.setZAccelOffset(1518);
